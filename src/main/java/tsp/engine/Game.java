...
/**
 * Classe qui gère les transitions des modes de jeu et possède les éléments de jeu en attributs
 */
public class Game {
	...
	public void reset(Window window) {
		...
		player.setPosition((window.getWidth()-player.getWidth())/2, window.getHeight() / 3);
